...
const AccessCodeInput = ({
  ...
  return <div className="space-y-2 bg-inherit">
      ...
      <div className="relative">
        ...
        <Input id="accessCode" name="accessCode" value={value} onChange={onChange} required className="bg-civic-dark/80 backdrop-blur-md pl-10 text-civic-light border-civic-accent/30 glow-border-focus focus:bg-civic-dark/90 bg-inherit" />
      </div>
