...
-- Create a function to handle new admin users
...
BEGIN
  ...
  ELSIF NEW.raw_user_meta_data ->> 'user_type' = 'user' OR NEW.raw_user_meta_data ->> 'user_type' IS NULL THEN
...
-- Create the new trigger for both admin and regular users
